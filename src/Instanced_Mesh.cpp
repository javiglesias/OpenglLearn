...
Instanced_Mesh::Instanced_Mesh(std::vector<Vertex> vertices, std::vector<unsigned int> indices, std::vector<Texture> textures)
{
...
void Instanced_Mesh::Draw(Shader& shader, glm::mat4 model, glm::mat4 view,
	...
	unsigned int texture)
{
	...
	glDrawArraysInstanced(GL_TRIANGLES, 0, indices.size(), instanced_positions.size());
	//glDrawElements(GL_TRIANGLES, indices.size(), GL_UNSIGNED_INT, 0);
	glBindVertexArray(0);
}

void Instanced_Mesh::setupMesh()
{
